...
COPY public.customer (id, name, age, email, mobile, e_id, data_id) FROM stdin;
...
119	Lawal Tamire	35	l_tamire@gmail.com	905211101	107	5
...
COPY public.department (manager_id, department, name, location, p_no) FROM stdin;
...
COPY public.staff (staff_id, staff_name, department, staff_sal, age, mobile) FROM stdin;
...
ALTER TABLE ONLY public.department
    ADD CONSTRAINT department_pkey PRIMARY KEY (manager_id);
